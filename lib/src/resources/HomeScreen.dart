...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({this.Myname = "Nguyễn Quang Khang"});
  ...
  Widget build(BuildContext context) {
    final tabs = [
      BlocProvider<ProductBloc>(
          create: (context) {
            return ProductBloc()..add(ProductLoadEvent());
          },
          child: BlocProvider<CategoryBloc>(
              create: (context) {
                return CategoryBloc()..add(InitiateEvent());
              },
              child: HomePage())
          //HomePage()
          ),
      BlocProvider<CartBloc>(
          create: (context) {
            return CartBloc()
              ..add(GetCartEvent(
                  person_id: context.bloc<LoginBloc>().user?.id?.toString()));
          },
          child: CartScreen(
              person_id: context.bloc<LoginBloc>().user?.id?.toString()))
      //HomePage()
